...
lab0:
0111 call	lab2		; 0117 does a simple call work?

lab1:	jp	0		; fail
	
lab2:
0117	pop	hl		; check return address
	ld	a,h
	cp	high lab1
	jp	z,lab3                    ; 0121
	jp	0
...
tcond:	macro	flag,pcond,ncond,rel
	ld	hl,&flag                  ; 0244 21  ld hl, 0001
	push	hl
	pop	af
0249	call	&pcond,lab1&pcond   ; 0249 dc  call c, 024f
024c	jp	error                 ; 024c c3  jp 0465
lab1&pcond:
024f	pop	hl
	ld	hl,0d7h xor &flag
	push	hl
